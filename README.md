# Uniswap V3 - Camelot V3 Arbitrage Bot

A sophisticated arbitrage trading bot that monitors price differences between Uniswap V3 and Camelot V3 on Arbitrum mainnet. The bot uses Balancer flash loans to execute profitable trades while automatically skipping unprofitable ones after calculating gas costs and slippage.

## 🚀 Features

- **Multi-Pair Monitoring**: Monitors 8 high-liquidity token pairs simultaneously
- **Real-Time Price Detection**: Detects swap events and calculates price differences in real-time
- **Flash Loan Arbitrage**: Uses Balancer flash loans for capital-efficient trading
- **Smart Execution**: Only executes profitable trades after accounting for gas costs
- **Web Interface**: Built-in web dashboard for monitoring bot performance
- **Cloud Ready**: Designed for deployment on Railway and other cloud platforms

## 📊 Monitored Token Pairs

| Pair | Uniswap V3 | Camelot V3 | Fee Tier |
|------|------------|------------|----------|
| WETH/USDC | ✅ | ✅ | 500 |
| WETH/USDT | ✅ | ✅ | 500 |
| WBTC/WETH | ✅ | ✅ | 500 |
...
- [Camelot V3](https://docs.camelot.exchange/) (Exchange - Algebra Protocol)
